...
//
// A prompt is chosen from the bundled library by day of year, so it is stable
// for the day and rotates automatically. Clicking copies the prompt and opens a
// new chat.
//
// To edit: add, remove, or reword entries in PROMPTS below. Change the
// destination by editing the URL in the onClick handler in render().
export const command = false;
export const refreshFrequency = 1000 * 60 * 60; // re-roll near the date change
